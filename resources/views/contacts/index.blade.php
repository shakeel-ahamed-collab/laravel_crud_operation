...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Mmebers</div>
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                @foreach($contacts as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/contact/' . $item->id) }}" title="View Student"><button class="btn btn-warning btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
